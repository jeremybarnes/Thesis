function newc = profilestump(datatype, numpoints)
...
%disp('Original (very old algorithm):');
%
%tic; newc = veryoldtrain(c, train_data); toc
%
%newc


disp('Newer algorithm, coded in MATLAB');

for i=1:1
   tic; newc = oldtrain(c, train_data); toc
end
...
disp('Newer algorithm, coded in C');
