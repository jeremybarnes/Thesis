function newc = profile_cart_classify(datatype, numpoints, cost_fn, maxdepth)

% PROFILE_CART_TRAIN profile the classification of the CART classifier
%
% SYNTAX:
%
...
disp('Original algorithm, coded in Matlab');
...
disp('Refined algorithm, coded in Matlab');
...
disp('Refined algorithm, coded in C');
