function [var, val, no_optimal] = ...
    optimal_split_gini(obj, x, y, w, cat)

% OPTIMAL_SPLIT_GINI calculate variable and value to split on
%
...
for i=1:dimensions
   ...
   for j=1:length(candidate_points-1) % leave out last point...
	 ...
	 right_dens = 0.0;
      ...
      Qleft = gini(left_dens);
      Qright = gini(right_dens);
