...
if (strcmp(get(obj, 'trainmethod'), 'stochastic'))
   ...
   trainagain_guts(obj, this_x, this_y);
else
   % exact --> train on all data at once
   trainagain_guts(obj, x_data, y_data);
end
