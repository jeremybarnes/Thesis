...
% EVAL_CF evaluate gravity boosting cost function
%
% SYNTAX:
%
...
% by H = F + alpha * f, where F is the classifier in obj, and f is
% another weaklearner.
%
% RETURNS:
%
...
% This section calculates the costs of the samples which would be
% calculated by the boosting algorithm.  Since the 

% Evaluate sample costs
sample_costs = exp(-margins) + lambda*norm([sample_weights(obj) alpha], ...
					   p);
d_sample_costs
