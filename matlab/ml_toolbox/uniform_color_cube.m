function color_map = uniform_color_cube(categories, bits)

% UNIFORM_COLOR_MAP color cube for displaying orthogonal categories
%
% SYNTAX:
%
% color_map = uniform_color_cube(categories, bits)
%
...
intensities = ((0:2.^bits-1) ./ (2.^bits-1))';
...
switch (categories)
   case 1
      color_map = [column1 zeros(l, 2)];
   case 2
      color_map = [column2(:, 1) zeros(l^2, 1) column2(:, 2)];
   case 3
      color_map = [column3(:, 1) column3(:, 3) column3(:, 2)];
end
